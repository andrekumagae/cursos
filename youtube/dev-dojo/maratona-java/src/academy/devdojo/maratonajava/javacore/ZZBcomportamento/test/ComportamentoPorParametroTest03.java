...
public class ComportamentoPorParametroTest02 {
    ...
    public static void main(String[] args) {
        ...
        //Na expressão lambda, retiramos a instaciação da classe, retirmamos a sobescrita e declaracao do unico method, pegamos e deixamos somente o parametro e retorno;
        //sintaxe: method(variávelDaLista, parâmetroDaInterface -> Valor ou method a ser retornado)
